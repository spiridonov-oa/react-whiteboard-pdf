...
_reactPdf.pdfjs.GlobalWorkerOptions.workerSrc = new URL(
...
const PDFReader = (_ref) => {
  ...
  const [currentPageNumber, setCurrentPageNumber] = (0, _react.useState)(
    (fileReaderInfo === null || fileReaderInfo === void 0
      ? void 0
      : fileReaderInfo.currentPageNumber) || 0,
  );
  const [totalPages, setTotalPages] = (0, _react.useState)(
    (fileReaderInfo === null || fileReaderInfo === void 0 ? void 0 : fileReaderInfo.totalPages) ||
      0,
  );
  ...
  const onDocumentLoadSuccess = (0, _react.useCallback)(
    (_ref2) => {
      let { numPages } = _ref2;
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    totalPages > 1 &&
      /*#__PURE__*/ _react.default.createElement(
        _PdfReader.PageInfoS,
        null,
        /*#__PURE__*/ _react.default.createElement(
          _PdfReader.NavigationButton,
          {
            type: 'button',
        ...
        /*#__PURE__*/ _react.default.createElement(
          _PdfReader.PageInfoDetails,
          null,
          'Page\xA0',
          /*#__PURE__*/ _react.default.createElement('b', null, currentPageNumber + 1),
          '\xA0of ',
          totalPages || '--',
        ),
        /*#__PURE__*/ _react.default.createElement(
