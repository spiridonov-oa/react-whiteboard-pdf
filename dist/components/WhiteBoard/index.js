...
var Whiteboard = function Whiteboard(_ref9) {
  var _ref9$aspectRatio = _ref9.aspectRatio,
      ...
      _ref9$opions = _ref9.opions,
      opions = _ref9$opions === void 0 ? {
    brushWidth: 5,
    width: '',
    height: ''
  } : _ref9$opions;
  ...
  var _useState2 = (0, _react.useState)(opions.brushWidth),
      brushWidth = _useState2[0],
      setBrushWidth = _useState2[1];

  var _useState3 = (0, _react.useState)(options.isFill),
      isFill = _useState3[0],
  ...
  (0, _react.useEffect)(function () {
    if (!canvas && canvasRef.current) {
      var _canvas = initCanvas(width ? width : whiteboardRef.current.clientWidth, height ? height : whiteboardRef.current.clientWidth / aspectRatio);
